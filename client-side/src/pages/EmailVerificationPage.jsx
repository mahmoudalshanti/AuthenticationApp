      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {code.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-2xl
                 font-bold bg-gray-700 text-white border-2 border-gray-600 rounded-lg focus:border-green-500 focus:outline-none"
              />
            ))}
          </div>
          ...
          <motion.button
            ...
            font-bold rounded-lg shadow-lg hover:to-emerald-700 
